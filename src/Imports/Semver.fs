...
type IExports =
    ...
    abstract prerelease:
        version: U2<string, SemVer> * ?optionsOrLoose: U2<bool, Semver.Options> -> ResizeArray<U2<string, float>> option
    ...
    /// </summary>
    abstract rcompare:
        v1: U2<string, SemVer> * v2: U2<string, SemVer> * ?optionsOrLoose: U2<bool, Semver.Options> -> RcompareReturn
    ...
    abstract intersects:
        range1: U2<string, Range> * range2: U2<string, Range> * ?optionsOrLoose: U2<bool, Semver.Options> -> bool
    ...
    abstract maxSatisfying:
        versions: ResizeArray<'T> * range: U2<string, Range> * ?optionsOrLoose: U2<bool, Semver.Options> -> 'T option

    /// Return the lowest version in the list that satisfies the range, or null if none of them do.
    abstract minSatisfying:
        versions: ResizeArray<'T> * range: U2<string, Range> * ?optionsOrLoose: U2<bool, Semver.Options> -> 'T option
    ...
    /// </summary>
    abstract simplify:
        ranges: ResizeArray<string> * range: U2<string, Range> * ?options: Semver.Options -> U2<string, Range>
...
[<AllowNullLiteral>]
type ComparatorStatic =
    [<EmitConstructor>]
    abstract Create: comp: U2<string, Comparator> * ?optionsOrLoose: U2<bool, Semver.Options> -> Comparator
...
type RangeStatic =
    [<EmitConstructor>]
    abstract Create: range: U2<string, Range> * ?optionsOrLoose: U2<bool, Semver.Options> -> Range
...
[<RequireQualifiedAccess>]
type SemVerCompareReturn =
    | N1 = 1
    | N0 = 0

[<RequireQualifiedAccess>]
type SemVerCompareMainReturn =
    | N1 = 1
    | N0 = 0

[<RequireQualifiedAccess>]
type SemVerComparePreReturn =
    | N1 = 1
    | N0 = 0

[<RequireQualifiedAccess>]
type SemVerCompareBuildReturn =
    | N1 = 1
    | N0 = 0
...
type SemVerStatic =
    [<EmitConstructor>]
    abstract Create: version: U2<string, SemVer> * ?optionsOrLoose: U2<bool, Semver.Options> -> SemVer

[<RequireQualifiedAccess>]
type CompareBuildReturn =
    | N1 = 1
    | N0 = 0

[<RequireQualifiedAccess>]
type CompareLooseReturn =
    | N1 = 1
    | N0 = 0
...
[<RequireQualifiedAccess>]
type CompareIdentifiersReturn =
    | N1 = 1
    | N0 = 0

[<RequireQualifiedAccess>]
type RcompareIdentifiersReturn =
    | N1 = 1
    | N0 = 0
...
[<Import("SEMVER_SPEC_VERSION", "semver")>]
let SEMVER_SPEC_VERSION: string = jsNative
...
[<Import("*", "semver")>]
let semver: Semver.IExports = jsNative
